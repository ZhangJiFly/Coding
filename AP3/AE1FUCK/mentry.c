...
unsigned long me_hash(MEntry *me, unsigned long size){
	...
	hashval = hashval + me->house_number; // adding the housenumber to the hashval
	return hashval % size; 
}	
...
int me_compare(MEntry *me1, MEntry *me2){
	...
	sprintf(string1, "%d\n", me1->house_number);
	strcat(strcat(string1, me1->surname), me1->postcode);
	sprintf(string2, "%d\n", me2->house_number);
	strcat(strcat(string2, me2->surname), me2->postcode);
