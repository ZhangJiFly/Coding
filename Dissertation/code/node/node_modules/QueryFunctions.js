...
module.exports = function(connection){
	...
	connection.query("SELECT Groups.GroupId,Minimum, Maximum, Groups.CourseListId, GroupHasCourse.CourseId, Course.Semester, Course.Name, Course.Level, Course.Credit FROM Course, Groups INNER JOIN GroupHasCourse ON Groups.CourseListId = GroupHasCourse.CourseListId AND Groups.GroupId = GroupHasCourse.GroupId WHERE GroupHasCourse.CourseId = Course.CourseId AND Groups.CourseListId IN (SELECT CourseListId FROM DegreeHasCourseList WHERE Degree = ?);", degree, function(error, rows, file){
		if (error) throw error;
		var info = {};
