/**
* Interface that must be supported by any implementation of a
* Bounded Buffer
*
...
/**
* method to insert "o" at the end of the buffer
* if no room, must wait until another thread has invoked
* remove()
*
